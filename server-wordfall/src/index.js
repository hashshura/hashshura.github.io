/*
 * Wordfall — Cloudflare Worker entry point.
 *
 ...
 *   Room  — one instance per room code. Owns the ready-up flow, the match once
 *           it starts, the WebSockets, and (for a private room) the salted
 *           password hash.
 *
 * Routes:
 ...
 *   GET  /room/:code/ws?name=&cls=&pw= -> WebSocket upgrade
 */
...
export default {
  async fetch(request, env) {
    ...
    return new Response('wordfall', { status: 404, headers: corsHeaders(origin) });
  }
};
